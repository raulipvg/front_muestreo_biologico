...
import { ClasificacionesService, IClasificacionModel } from '../../../../services/clasificaciones/clasificaciones.service';
...
export class ModalAccionesComponent implements OnInit {
  ...
  modalConfig: ModalConfig = {
    modalTitle: `Clasificacion: ${this.nombre}`,
  ...
  @Output() cambioRowEvent = new EventEmitter<IClasificacionModel>();
  @Output() agregaRowEvent = new EventEmitter<IClasificacionModel>();
  ...
  Submit() {
    ...
    const successAlert: SweetAlertOptions = {
      icon: 'success',
      title: 'Exito',
      text: this.editar ? 'Clasificación actualizada' : 'Clasificación registrada'
    };
