...
import { LugaresmService, ILugarmModel } from '../../../services/lugaresm/lugaresm.service';
...
@Component({
  ...
  templateUrl: './lugaresm.component.html',
  styleUrl: './lugaresm.component.scss'
})
export class LugaresmComponent implements OnInit {
  ...
  cargando : boolean = false;
   ...
   constructor(
    private servicio: LugaresmService, 
  ...
  ngAfterViewInit(): void {
    this.servicio.getAll().subscribe((data: ILugarmModel[]) => {
