...
import { DepartamentosService, IDepartamentoModel } from '../../../services/departamentos/departamentos.service';
...
export class DepartamentosComponent implements OnInit {
  ...
  cargando : boolean = false;
   ...
   constructor(
    private servicio: DepartamentosService, 
  ...
  ngAfterViewInit(): void {
    this.servicio.getAll().subscribe((data: IDepartamentoModel[]) => {
